...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        ['name' => 'Gà Rán 6 Miếng', 'price' => 85000, 'category' => 'Gà Rán', 'image' => 'images/products/ga-ran.jpg'],
        ['name' => 'Khoai Tây Chiên', 'price' => 35000, 'category' => 'Món Phụ', 'image' => 'images/products/khoai-tay.jpg'],
        ['name' => 'Hot Dog Xúc Xích', 'price' => 45000, 'category' => 'Hot Dog', 'image' => 'images/products/hot-dog.jpg'],
        ['name' => 'Coca Cola', 'price' => 20000, 'category' => 'Đồ Uống', 'image' => 'images/products/coca.jpg'],
