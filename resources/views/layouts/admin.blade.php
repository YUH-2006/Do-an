    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar__nav">
            <a href="{{ route('admin.dashboard') }}"
               class="sidebar__link {{ request()->is('admin/dashboard*') ? 'is-active' : '' }}">
                Thống kê doanh thu
            </a>
            ...
            <a href="{{ route('admin.users.index') }}"
               class="sidebar__link {{ request()->is('admin/users*') ? 'is-active' : '' }}">
                Quản lý Khách hàng
            </a>
            <a href="{{ route('admin.orders.index') }}"
               class="sidebar__link {{ request()->is('admin/orders*') ? 'is-active' : '' }}">
                Quản lý Đơn hàng
            </a>
